...
public class EditVatTuDialog extends JDialog {
    ...
    public EditVatTuDialog(JFrame parent, VatTu vatTu) {
        super(parent, "Sửa vật tư", true);
        this.productId = vatTu.getId();
        initComponents();
        loadData(vatTu);
        setSize(400, 450);
    ...
    private void loadData(VatTu vatTu) {
        txtTenVatTu.setText(vatTu.getTenVatTu());
        txtNhaCungCapId.setText(String.valueOf(vatTu.getNhaCungCapId()));
        txtDonViTinh.setText(vatTu.getDonViTinh());
        txtGiaTien.setText(String.valueOf(vatTu.getGiaTien()));
        txtSoLuong.setText(String.valueOf(vatTu.getSoLuong()));
        txtMoTa.setText(vatTu.getMoTa());
        txtKhoId.setText(String.valueOf(vatTu.getKhoId()));
        chkTinhTrang.setSelected(vatTu.isTinhTrang());
    }
